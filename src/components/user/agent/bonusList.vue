          ...
          >
            ...
            >
              ...
              <div class="info-group">
                <div class="info-left">
                  <div class="value">{{formatDate(item.start_time*1000)}} - {{formatDate(item.end_time*1000)}}</div>
                  <div class="text">分红周期</div>
                </div>
                ...
                <div class="info-right">
                  <div class="value red-color">{{item.amount}}</div>
...
.contractGroup .group-middle .group-middle-left,
.contractGroup .group-middle .group-middle-right {
  flex: 0 0 50%;
  display: flex;
...
.contractGroup .group-middle > div .info-item {
  display: flex;
  flex-flow: row nowrap;
  justify-content: flex-start;
  align-items: flex-start;
...
.contractGroup .group-middle > div .info-item .text {
  flex: 0 0 60px;
  margin-right: 30px;
  font-size: 14px;
  color: #666666;
...
.contractGroup .group-middle > div .info-item .value {
  line-height: 1.2;
  flex: 1;
  font-size: 15px;
  color: #333333;
