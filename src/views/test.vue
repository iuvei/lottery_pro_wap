...
export default {
  ...
  created() {
    let filter = _.groupBy([{ a: 1 }, { a: 1 }, { a: 2 }], item => item.a)
    console.log(filter)
  },
  methods: {
    handleMessageCancel() {
